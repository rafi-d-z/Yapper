...
<div className="w-full h-full flex">
  ...
  <div className="w-7/12 flex flex-col items-center justify-center">
    ...
    <p className='text-[#8E8181] font-bold text-md'>Learn what is going on in the world</p>
  </div>
  ...
  <div className="w-11/12 h-full flex flex-col items-center justify-center">
    <div className="w-5/12 h-52 border border-slate-200 drop-shadow mt-7">
      <div className="w-11/12 h-full flex flex-col gap-4 justify-center border-slate-200 drop-shadow items-center">
        ...
        />
        <button className="w-full h-8 bg-[#52C41A] text-white font-bold" onClick={handleLogin}>
          Login
        </button>
        <a
          href="#"
    ...
    <p className='text-[#858585] font-normal'>
      ...
      <a href="https://twitter.com/en/tos" className='underline'> Terms of Service</a> and 
      <a href="https://twitter.com/en/privacy" className='underline'> Privacy Policy</a>, including
      <a href="https://help.twitter.com/en/rules-and-policies/x-cookies" className='underline'> Cookie Use.</a>
    </p>
  </div>
</div>
